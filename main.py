...
def main(experiment, dataset, algorithm, model, batch_size, learning_rate, alpha, eta, L, rho, num_glob_iters,
    ...
    for i in range(times):
        ...
        if model == "logistic_regression":
            model = Logistic_Regression().to(device), model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="DANE",choices=["Sophia","Sophia-2","DONE", "GD", "DANE", "Newton", "GT", "PGT", "FEDL","GIANT"])
